        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              {(notice || error) && (
                <div className={`${error ? 'bg-red-50 border-red-200' : 'bg-blue-50 border-blue-200'} border rounded-md p-4`}>
                  <div className="flex">
                    <AlertCircle className={`h-5 w-5 ${error ? 'text-red-400' : 'text-blue-500'}`} />
                    <div className="ml-3">
                      <p className={`text-sm ${error ? 'text-red-800' : 'text-blue-800'}`}>{error || notice}</p>
                    </div>
                  </div>
                </div>
              )}
